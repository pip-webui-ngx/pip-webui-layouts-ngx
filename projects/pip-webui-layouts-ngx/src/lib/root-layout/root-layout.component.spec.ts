...
describe('a root-layout component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [PipRootLayoutComponent],
      imports: [NoopAnimationsModule, FlexLayoutModule, MatSidenavModule],
      providers: [PipMediaService, PipRightnavService, PipSidenavService],
    });
